  ...
  Learn More
      ...
      <section id="download" className="py-16 bg-blue-600 text-white">
        ...
        <div className="text-center bg-white p-4 rounded-lg shadow-lg">
          ...
          <img src="/frame.png" alt="Pickers' App" className="rounded-lg mb-4 mx-auto" />
          <a href="/kenawpwa.apk" className="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 flex items-center justify-center mx-auto">
